        ...
        <Tabs defaultValue="overview" className="w-full min-w-0">
          ...
          <TabsContent value="overview" className="space-y-3">
            ...
            <div className="space-y-3 text-sm text-muted-foreground">
              <p>
                Every node is a real cast. An arrow points from a cast to the casts that quoted it,
                so the shape of the tree is the shape of the conversation.
              </p>
              <p>
                Data is fetched at request time through a server-side Farcaster data endpoint —
                nothing is hardcoded and no wallet, account, or sign-in is required. Because the API
                cannot prove exhaustiveness, the tree is presented as a live reconstruction.
              </p>
              <p>
                Profile locations shown in the details panel are self-declared by each Farcaster
                user. They are not birthplaces or hometowns.
              </p>
              <ul className="space-y-1 text-sm">
                ...
                {GITHUB_URL ? (
                  ...
                  <li className="text-xs">
                    Source repository link: configure in src/lib/constants.ts
                  </li>
                )}
              </ul>
            </div>
